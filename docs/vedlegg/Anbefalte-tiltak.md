...
!!! quote "Pasientinformasjonslokalisator"
    ...
    ...
    Et slikt register bør etableres som en fellestjeneste hvor det fremgår hvem som har helseopplysninger om en gitt pasient. Vi har valgt å kalle denne fellestjenesten for pasientinformasjonslokalisator, forkortet til PIL.

#### Status for etablering av PIL - januar 2023

Det eksisterer idag ikke noen tiltak knyttet til å etablere fellestjeneste for PIL i samhandlingsinfrastrukturen for helsesektoren
