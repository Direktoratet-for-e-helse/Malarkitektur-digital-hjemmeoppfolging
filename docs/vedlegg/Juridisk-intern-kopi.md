...
![Figur som viser et behandlignsrettet helseregister bygd opp av flere logiske moduler. Illustrasjon.](../img/logiske-moduler.svg)  
...
![Figur som viser løsningsmønster basert på optimalisert kopi for datadeling. Illustrasjon.](../img/optimalisert-kopi.png)  
...
![Figur som viser løsningsmønster basert på optimalisert kopi for datadeling hos ekstern databehandler](../img/optimalisert-kopi-databehandler.png)  
